public class SchoolApp {
    public static void main(String[] args) {
        Student student1 = new Student("Arnol", "Martinez", "Arnol@gmail.com", "Conocido en Iguala Gro.",22,"informatica",8.5);

        Teacher teacher1 = new Teacher( "Marcos", "Roman", "Marcos@gmail.com", "Industria");
